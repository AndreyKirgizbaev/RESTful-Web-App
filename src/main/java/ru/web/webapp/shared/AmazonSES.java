...
import ru.web.webapp.security.SecurityConstants;
import ru.web.webapp.shared.dto.UserDTO;

@Service
public class AmazonSES {
    // This address must be verified with Amazon SES.
    final String FROM = "4yma545@gmail.com";

    // The subject line for the email.
    final String SUBJECT = "One last step to complete your registration with WebApp";
    ...
    public void verifyEmail(UserDTO userDTO) {
        ...
        System.setProperty("aws.accessKeyId", SecurityConstants.getAmazonAccessKeyId());
        System.setProperty("aws.secretKey", SecurityConstants.getAmazonSecretKey());
